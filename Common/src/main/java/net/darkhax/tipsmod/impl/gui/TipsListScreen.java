...
public class TipsListScreen extends OptionsSubScreen {
    ...
    public TipsListScreen(Screen screen, Options settings) {
        ...
        super(screen, settings, new TranslatableComponent("gui.tips.list.title"));
    }
    ...
    protected void init () {
        ...
        this.searchBar = new ButtonTextField(this.font, this.width / 2 - 150 / 2 - 50, this.height - 26, 150, 20, new TranslatableComponent("gui.tips.list.search"));
        this.addRenderableWidget(this.searchBar);
        
        this.showDisabled = new FunctionalCheckbox(this.width / 2 - 20 / 2 + 50, this.height - 26, 20, 20, new TranslatableComponent("gui.tips.list.show_disabled"), false, p -> this.list.refreshEntries(p, this.searchBar.getValue()));
        this.addRenderableWidget(this.showDisabled);
        
        this.openConfigFile = new Button(this.width - 70, this.height - 26, 60, 20, new TranslatableComponent("gui.tips.list.config"), this::openConfigFile);
